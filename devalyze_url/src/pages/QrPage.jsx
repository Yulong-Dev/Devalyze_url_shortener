                ...
                {loading ? (
                    ...
                    <div className="flex flex-col p-4 gap-3">
                        {qrs.map((qr) => (
                            <div
                                key={qr._id}
                                className="flex items-center gap-3 p-3 border rounded-md hover:bg-gray-50 transition relative"
                            >
                                {/* QR Image */}
                                <img
                                    src={qr.qrCodeUrl}
                                ...
                                <div className="flex flex-col flex-1">
                                    <p
                                        className="text-sm text-gray-700 truncate mb-1 max-w-[200px] sm:max-w-[300px]"
                                        title={qr.longUrl}
                                    >
                                        {qr.longUrl}
                                    </p>
