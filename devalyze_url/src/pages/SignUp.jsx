...
const Create = () => {
  ...
  pulse: {
    scale: [1, 1, 1], // Keyframes for pulsing
    transition: {
      duration: 2,
      repeat: Infinity,
      ease: "easeInOut"
...
const googleButtonVariants = {
  ...
  <g opacity="0.9" clip-path="url(#clip0_2880_619)">
    <path d="M18.7979 10.2138C18.7979 9.58841 18.7425 8.99466 18.6475 8.41675H9.70166V11.9872H14.8237C14.5942 13.1588 13.9212 14.1484 12.9237 14.8213V17.1963H15.9796C17.7687 15.5418 18.7979 13.1034 18.7979 10.2138Z" fill="#4285F4"/>
    <path d="M9.70189 19.5001C12.2669 19.5001 14.4124 18.6451 15.9799 17.1963L12.9239 14.8213C12.0689 15.3913 10.9844 15.7396 9.70189 15.7396C7.22399 15.7396 5.12607 14.0693 4.37399 11.813H1.22314V14.2593C2.78274 17.3626 5.98899 19.5001 9.70189 19.5001Z" fill="#34A853"/>
    <path d="M4.37375 11.8128C4.17583 11.2428 4.07291 10.6332 4.07291 9.99988C4.07291 9.36655 4.18375 8.75697 4.37375 8.18697V5.74072H1.22291C0.573743 7.02322 0.20166 8.46405 0.20166 9.99988C0.20166 11.5357 0.573743 12.9766 1.22291 14.2591L4.37375 11.8128Z" fill="#FBBC05"/>
    <path d="M9.7019 4.26042C11.1031 4.26042 12.3539 4.74334 13.3436 5.68542L16.0511 2.97792C14.4124 1.44208 12.2669 0.5 9.7019 0.5C5.98899 0.5 2.78274 2.6375 1.22314 5.74084L4.37399 8.18709C5.12607 5.93084 7.22399 4.26042 9.7019 4.26042Z" fill="#EA4335"/>
  </g>
  <defs>
    <clipPath id="clip0_2880_619">
      <rect width="19" height="19" fill="white" transform="translate(0 0.5)"/>
                        ...
                        <motion.div 
                            ...
                            variants={itemVariants}
                        >
                            <p className='text-[#aeaeae] text-center font-geist text-lg font-medium tracking-wide'>Don't have an account?</p>
