        ...
        <div className="p-4 sm:p-6 min-h-screen bg-gray-100">
                    ...
                    {recentLinks.length > 0 ? (
                        <ul className="flex flex-col gap-2">
                            ...
                            <div className="flex justify-center items-center gap-1 pt-3 text-gray-600 border-t mt-2">
                                <Link to="links" className="hover:text-gray-800">See all links</Link>
                                <ArrowRight className="h-4 w-4" />
                            </div>
                        </ul>
                    ) : (
                        <p className="text-gray-500 text-center py-4">No recent links found.</p>
                    )}
                </div>
                ...
                <div className="bg-white w-full lg:w-[calc(50%-0.75rem)] p-4 sm:p-5 rounded-xl shadow-lg border">
                    ...
                    {recentQrs.length > 0 ? (
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="flex justify-center items-center gap-1 pt-3 text-gray-600 border-t mt-2">
                                <Link to="qrcodes" className="hover:text-gray-800">See all QR codes</Link>
                                <ArrowRight className="h-4 w-4" />
                            </div>
                        </div>
                    ) : (
            ...
            <div className="flex flex-col lg:flex-row gap-4 sm:gap-6">
                    ...
                    {pageStats ? (
                        <div>
                            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 mb-4">
                                ...
                                <div className="flex-1 text-center sm:text-left w-full">
                                    ...
                                    <p className="text-sm text-gray-500 mb-2">@{pageStats.username}</p>
                                    ...
                                    <div className="grid grid-cols-3 gap-2 text-xs text-gray-600 mb-3">
                                        <div className="bg-gray-50 rounded p-2">
                                            <p className="font-semibold text-gray-900">{pageStats.totalViews}</p>
                                            <p className="text-gray-500">Views</p>
                                        </div>
                                        <div className="bg-gray-50 rounded p-2">
                                            <p className="font-semibold text-gray-900">{pageStats.totalLinks}</p>
                                            <p className="text-gray-500">Links</p>
                                        </div>
                                        <div className="bg-gray-50 rounded p-2">
                                            <p className="font-semibold text-gray-900 text-[10px] sm:text-xs">
                                                {new Date(pageStats.createdAt).toLocaleDateString('en-US', { month: 'short', day: 'numeric' })}
                                            </p>
                            ...
                            <div className="flex justify-center items-center gap-1 pt-3 text-gray-600 border-t">
                                <Link to="pages" className="hover:text-gray-800">Manage Pages</Link>
                                <ArrowRight className="h-4 w-4" />
                            </div>
                        </div>
                    ) : (
                        <div className="text-center text-gray-500 py-8">
                            ...
                            <p className="text-sm mb-4">
                                Go to the <span className="font-semibold">Pages</span> section to create one.
                            </p>
                            <Link
                                to="pages"
                ...
                <div className="bg-white w-full lg:w-[calc(50%-0.75rem)] p-4 sm:p-5 rounded-xl shadow-lg border">
                    ...
                    {analytics.length > 0 && (analytics[0].value > 0 || analytics[1].value > 0) ? (
                        ...
                        <div className="text-center text-gray-500 py-16">
                            <p className="text-base sm:text-lg font-semibold mb-2">No analytics data yet</p>
                            <p className="text-sm">Start creating links and QR codes to see your stats here.</p>
                        </div>
                    )}
                </div>
            </div>
