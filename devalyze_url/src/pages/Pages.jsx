        ...
        <div className={`flex gap-3`}>
          <div className={`flex-2/3 gap-3 flex flex-col`}>
            <main className={`pb-2 min-h-100 flex flex-col gap-5`}>
              ...
              <div className="flex flex-col gap-2 items-center">
                <div
                  className={`flex flex-col w-[95%] p-2 bg-[#F6F7F5] rounded-sm`}
                >
                  ...
                  <input
                    ...
                    name={`username`}
                    placeholder="Name"
                    className="outline-none py-2 rounded-md w-full"
              ...
              <button
                ...
                className={`flex gap-1 items-center p-2 px-4 ml-5`}
              >
            ...
            <div className="flex gap-2 p-2 min-h-100"></div>
          </div>
          <aside className=" p-2 py-5 min-h-120 flex-1/3 flex items-start gap-2 justify-center">
            ...
            <div className="flex flex-col gap-1 items-center justify-center">
              ...
              <p className={`text-[#292929] text-center text-md font-medium`}>
                {profile.bio}
              </p>
              <span></span>
            </div>
