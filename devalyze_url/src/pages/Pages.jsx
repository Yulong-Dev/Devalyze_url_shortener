...
function Pages() {
  ...
  try {
    ...
    const options = {
      maxSizeMB: 0.2, // target around 200KB
      maxWidthOrHeight: 1280, // resize large images (optional)
      useWebWorker: true,
      initialQuality: 0.6, // compress quality
    };
    ...
    // Convert compressed file to Base64 for preview and backend storage
