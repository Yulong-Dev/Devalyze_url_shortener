...
const navLinks = [
    ...
    { name: "Analytics", icon: <TrendingUp size={18} />, path: "/dashboard/analytics" },
    { name: "Domains", icon: <Globe size={18} />, path: "/dashboard/domains", badge: "Upgrade" },
];

const navLinks2 = [
    { name: "Support", icon: <HelpCircle size={18} />, path: "/dashboard/support" },
...
const DashboardLayout = () => {
    ...
    const getRandomColor = (name) => {
        const colors = [
            ...
            "#8BC34A", "#FFC107", "#FF9800", "#FF5722", "#607D8B",
        ];
        let hash = 0;
            ...
            <div className="flex-1 flex flex-col bg-white overflow-y-auto">
                ...
                <header className="flex justify-between items-center gap-3 p-3 border-b bg-white sticky top-0 z-40">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        {/* Icons */}
                        <Bell size={22} className="hidden sm:block text-gray-600 cursor-pointer" />
                        <HelpCircle size={22} className="hidden sm:block text-gray-600 cursor-pointer" />
