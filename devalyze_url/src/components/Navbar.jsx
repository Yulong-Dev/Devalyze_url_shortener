      ...
      >
        <div className="h-12 w-35 gap-3 bg-white shadow-md rounded-lg flex items-center justify-center">
          <LazyLoadImage 
            ...
            effect="opacity"
          />
          <h1 className="text-blue-900 text-center text-lg font-thin">Devalyze</h1>
        </div>
      </motion.div>
      ...
      >
        ...
        >
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="15" viewBox="0 0 18 18" fill="none">
            <path d="M13.5 7.375L9 11.875L4.5 7.375" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </motion.button>
